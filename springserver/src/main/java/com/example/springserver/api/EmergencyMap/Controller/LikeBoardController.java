...
public class LikeBoardController {
    ...
    @Operation(summary = "병원 좋아요", description = """
            병원을 좋아요하는 기능입니다.<br>
            헤더에 accessToken을 넣어주세요. body에 병원정보를 넣어주세요.<br>
            """)
    // 좋아요 병원 등록
    @PostMapping("/like")
    ...
    @Operation(summary = "병원 좋아요 취소하기", description = """
            병원좋아요를 취소하는 기능입니다.<br>
            헤더에 accessToken을 넣어주세요. 취소하려는 병원아이디(숫자)를 넣어주세요<br>
            """)
